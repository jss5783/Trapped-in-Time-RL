...
---CHANGELOG---
2019/04/23		(JSS5783)
				Replaced real arrow symbols with fake arrow symbols in controls message.
...
def main():
	...
	log.addMessage("SYSTEM: [g]rab item / [t]ime-travel / [<^v>] move")
...
# 			if map1.getUnderPlayer().strName == "portal":
			if map1.getEntityIndexAt(Portal, map1.getPlayerX(), map1.getPlayerY()) != -1:
				print("level up")
